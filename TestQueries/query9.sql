...
create view v as
select u.dept, extract(year from WeekDate) as yr, extract(month from WeekDate) as mo, sum(sales.WeeklySales) as cumulative_sales 
from hw3.sales 
join u on hw3.sales.dept = u.dept 
group by u.dept, yr, mo 
order by u.dept, yr, mo;

select dept, yr, mo, sum(cumulative_sales) over (order by dept, yr, mo rows unbounded preceding) as total
from v;
...
JDBC APP OUTPUT
dept 2, yr 2010, mo 11, total 83907376
dept 13, yr 2012, mo 4, total 4.4152602e+08
dept 38, yr 2011, mo 7, total 6.8974931e+08
dept 38, yr 2012, mo 6, total 8.2531622e+08
dept 40, yr 2010, mo 4, total 8.981559e+08
dept 40, yr 2012, mo 8, total 1.1434916e+09
dept 72, yr 2011, mo 10, total 1.3526764e+09
dept 91, yr 2012, mo 4, total 1.9338787e+09
dept 92, yr 2012, mo 6, total 2.3973174e+09
dept 94, yr 2010, mo 7, total 2.4937971e+09
